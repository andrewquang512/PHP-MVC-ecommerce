...
<div class="container-fluid">
  <a href="tintuc.php" class="previous">&laquo; Previous</a> 
  <div class="row">
  <div class="col-8 col-md-8">
    <h3 class="titlehome">Chi tiết tin tức</h3>
    <div class="news-info" style="padding-top: 20px;">
        <h2 style="padding-bottom:20px;color:#34d3e4">Giảm nhiệt tình loạt điện thoại Samsung Galaxy A, ưu đãi bạc triệu đáng mua nhất cuối tháng 9, tậu ngay đừng bỏ qua </h2>
        <img src="https://cdn.tgdd.vn/Files/2021/09/23/1385080/samsunggalaxya72-2_1280x720-300x200.jpg" style="border-radius:10px;" width="600">
        <div style="display: flex;padding-top:20px;">
            <img src="../../../public/assets/images/tgdd.png" style="" height="60" width="200"> 
            <h5 style="color:#BFBFBF;padding: 18px 0 0 280px"> <i>1 giờ trước</i></h5>
        </div>
        <p style="width: 700px;padding-top:20px;font-size:18px;">Samsung Galaxy A "hót hòn họt" luôn có lượt mua khủng ở Thế Giới Di Động, hiện đang được sale nhiệt tình trợ giá mùa dịch.Ưu đãi áp dụng từ 24/9 đến 27/9/2021 với: Giảm ngay 1 triệu đồng, giá chỉ còn 10.990.000 đồng + Hỗ trợ trả góp 0% + Quà tặng Galaxy trị giá 1 triệu.</p>
    </div>
