      ...
      <div class="collapse navbar-collapse ml-auto " id="collapsibleNavId">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0 ml-auto ">
          <li class="nav-item active">
            <a class="nav-link text-dark" style=" font-size: 1em;font-weight: bold;" href="./?controller=pages&action=home">TRANG CHỦ <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-dark" style=" font-size: 1em;font-weight: bold;"href="./?controller=pages&action=gioithieu">GIỚI THIỆU</a>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link text-dark"style=" font-size: 1em;font-weight: bold;" href="./?controller=pages&action=sanpham" >SẢN PHẨM</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-dark"style=" font-size: 1em;font-weight: bold;" href="./?controller=pages&action=lienhe">LIÊN HỆ</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-dark"style=" font-size: 1em;font-weight: bold;" href="./?controller=pages&action=tintuc">TIN TỨC</a>
          </li>
        </ul>
