...
?> 
  ...
  <script type="text/javascript" src="<?php echo (CSSPATH . 'bootstrap/js/bootstrap.min.js'); ?>"></script>
  <script type="text/javascript" src="<?php echo (JSPATH . 'myScript.js'); ?>"></script>
