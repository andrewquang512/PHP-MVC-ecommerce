                    ...
                    <div id="myCarousel" class="carousel slide " data-ride="carousel">
                        ...
                        <div class="carousel-inner ">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="<?php echo (CSSPATH . 'images/dtdd/phone9/1.png'); ?>" alt="first-slider" style="justify-content: center;"
                                    style="max-height: 300px;">

                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<?php echo (CSSPATH . 'images/dtdd/phone9/2.png'); ?>" alt="second-slider" style="justify-content: center;"
                                    style="max-height: 300px;">

                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<?php echo (CSSPATH . 'images/dtdd/phone9/3.png'); ?>" alt="thirds-slider" style="justify-content: center;"
                                    style="max-height: 300px;">
