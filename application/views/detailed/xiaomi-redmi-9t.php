            ...
            <div class="path">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">XIAOMI</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div id="myCarousel" class="carousel slide " data-ride="carousel">
                        ...
                        <div class="carousel-inner ">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="http://localhost/PHP-MVC-ecommerce/public/assets/images/dtdd/phone5/1.png" alt="first-slider" style="justify-content: center;"
                                    style="max-height: 300px;">

                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="http://localhost/PHP-MVC-ecommerce/public/assets/images/dtdd/phone5/2.png" alt="second-slider" style="justify-content: center;"
                                    style="max-height: 300px;">

                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="http://localhost/PHP-MVC-ecommerce/public/assets/images/dtdd/phone5/3.png" alt="thirds-slider" style="justify-content: center;"
                                    style="max-height: 300px;">
  ...
  $('.btn-buy').click(function(){
    ...
    <?php
          ...
          if($total_row==0){
            ...
            $query2="INSERT INTO phone_in_bill VALUE ($Billid,5,1);";
            $statement2 = $connect->prepare($query2);
            $statement2->execute();
          }
          else{
            $Billid=$result['BID'];
            $query3="INSERT INTO phone_in_bill VALUE ($Billid,5,1);";
